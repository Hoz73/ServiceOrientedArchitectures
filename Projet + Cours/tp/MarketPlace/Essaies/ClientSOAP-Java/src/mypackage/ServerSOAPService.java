 ...
 * 
 */
@WebServiceClient(name = "ServerSOAPService", targetNamespace = "http://example.com/", wsdlLocation = "http://localhost:8080/ServerSOAP-1.0-SNAPSHOT/services/ServerSOAP?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SERVERSOAPSERVICE_QNAME = new QName("http://example.com/", "ServerSOAPService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/ServerSOAP-1.0-SNAPSHOT/services/ServerSOAP?wsdl");
    ...
    public ServerSOAP getServerSOAPPort() {
        return super.getPort(new QName("http://example.com/", "ServerSOAPPort"), ServerSOAP.class);
    }
    ...
    public ServerSOAP getServerSOAPPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://example.com/", "ServerSOAPPort"), ServerSOAP.class, features);
    }
